...
class Square_Block():
    def __init__(self, x, y, speed = 625):
        ...
        block_1 = Blocks(yellow, 135, 15, 30, 30)
        block_2 = Blocks(yellow, 135, 45, 30, 30)
        block_3 = Blocks(yellow, 165, 15, 30, 30)
        block_4 = Blocks(yellow, 165, 45, 30, 30)
