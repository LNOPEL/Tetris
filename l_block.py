...
class L_Block():
    def __init__(self, x, y, speed = 625, color = orange):
        self.state = 0
        self.x = x
        self.y = y
        self.move_down = speed

        block_1 = Blocks(color, 135, 15, 30, 30)
        block_2 = Blocks(color, 135, 45, 30, 30)
        block_3 = Blocks(color, 135, 75, 30, 30)
        block_4 = Blocks(color, 165, 75, 30, 30)
