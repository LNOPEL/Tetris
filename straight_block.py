...
class Straight_Block():
    def __init__(self, x, y, speed = 625):
        ...
        block_1 = Blocks(cyan, 135, 15, 30, 30)
        block_2 = Blocks(cyan, 135, 45, 30, 30)
        block_3 = Blocks(cyan, 135, 75, 30, 30)
        block_4 = Blocks(cyan, 135, 105, 30, 30)
